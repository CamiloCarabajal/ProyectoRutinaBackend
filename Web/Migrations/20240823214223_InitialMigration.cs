        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseMachine = table.Column<bool>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Exercises",
                columns: new[] { "Id", "Category", "Name", "UseMachine" },
                values: new object[,]
                {
                    { 1, "Alta", "Press de pecho", true },
                    { 2, "Baja", "Curl de biceps", false },
                    { 3, "Baja", "Sentadillas", true },
                    { 4, "Media", "Abdominales", false }
                });
